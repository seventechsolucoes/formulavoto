                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-body">
                                    <form id="formAtualizar">
                                        ...
                                        <input type="hidden" id="status" name="status" value="<?= $evento->status ?>">
                                        <div class="form-row">
                                            <div class="col-12 form-group">
                                                <label for="titulo">Título</label>
                                                <input type="text" id="titulo" name="titulo" class="form-control" placeholder="Informe o título do evento" value="<?= $evento->titulo ?>">
                                        ...
                                        <div class="form-row">
                                            <div class="col-12 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input type="text" id="hora" name="hora" class="form-control clockpicker" placeholder="00:00" value="<?= $evento->hora ?>">
                                                <span class="invalid-feedback"></span>
                                            </div>
                                            <div class="col-12 col-md-6 col-sm-6 form-group">
                                                <label for="data">Data</label>
                                                <input type="text" id="data" name="data" class="form-control" placeholder="00/00/0000" value="<?= date("d/m/Y", strtotime($evento->data)) ?>">
                                                <span class="invalid-feedback"></span>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-12 form-group">
                                                ...
                                                <textarea id="descricao" name="descricao" class="form-control" rows="4" placeholder="Informe a descrição do evento"><?= $evento->descricao ?></textarea>
                                                <span class="invalid-feedback"></span>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-12 form-group">
                                                ...
                                                <textarea id="observacoes" name="observacoes" class="form-control" rows="4" placeholder="Observações sobre o evento ou sobre a postagem"><?= $evento->observacoes ?></textarea>
                                                <span class="invalid-feedback"></span>
                                            </div>
                                        </div>
...
<script src="<?= base_url("public/app/js/agendas/atualizar.controller.js") ?>"></script>
